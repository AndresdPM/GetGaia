...
def main(argv):  
   ...
   parser.add_argument('--prepare_for_clustering', type = float, default = None, help = 'Preselect sources before the last clustering. If a value is given, only PM compatible with the PMs provided as input within that number plus error will be considered.')
   ...
   if args.use_members:
      ...
      if args.prepare_for_clustering is not None:
