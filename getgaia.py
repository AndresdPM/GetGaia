...
def plot_final_selection(args, data, ellipse = None, plot_prob = True):
   ...
   ax2.errorbar(args.pmra, args.pmdec, xerr = args.pmra, yerr= args.pmdec, fmt='ro', ms = 2, ecolor='r', label = 'Ma20', zorder = 3)

   ax5.errorbar(args.pmra, args.pmdec, xerr = args.pmra, yerr= args.pmdec, fmt='ks', ms = 2, ecolor='k', label = 'Mc20', zorder = 2)
   ax5.errorbar(args.pmra, args.pmdec, xerr = args.pmra, yerr= args.pmdec, fmt='ro', ms = 2, ecolor='r', label = 'Ma20', zorder = 3)
